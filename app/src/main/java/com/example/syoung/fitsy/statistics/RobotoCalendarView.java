...
public class RobotoCalendarView extends LinearLayout {
    ...
    public void CheckDayZero(Date currentDate) {
        // Initialize attributes
        Calendar currentCalendar = getCurrentCalendar();
        currentCalendar.setTime(currentDate);
    ...
    public void CheckDayHalf(Date currentDate) {
        ...
        ViewGroup dayOfMonthBackground = getDayOfMonthBackground(currentCalendar);
        storeLastValues(currentDate);
        dayOfMonthBackground.setBackgroundResource(R.color.purple);
        TextView dayOfMonth = getDayOfMonthText(currentCalendar);
        dayOfMonth.setTextColor(context.getResources().getColor(WHITE_COLOR));

    }

    public void CheckDayPft(Date currentDate) {
        // Initialize attributes
        Calendar currentCalendar = getCurrentCalendar();
        currentCalendar.setTime(currentDate);
        ...
        ViewGroup dayOfMonthBackground = getDayOfMonthBackground(currentCalendar);
        storeLastValues(currentDate);
        dayOfMonthBackground.setBackgroundResource(R.color.realblue);
        TextView dayOfMonth = getDayOfMonthText(currentCalendar);
        dayOfMonth.setTextColor(context.getResources().getColor(WHITE_COLOR));
